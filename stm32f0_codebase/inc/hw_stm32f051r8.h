...
#define ADC_ISR_EOSMP_MASK              0x2u
#define ADC_ISR_EOSMP_SHIFT             1u
#define ADC_ISR_EOSMP(x)                (((uint32_t)(((uint32_t)(x))<<ADC_ISR_EOSMP_SHIFT))&ADC_ISR_EOSMP_MASK)
#define ADC_ISR_EOC_MASK                0x4u
#define ADC_ISR_EOC_SHIFT               2u
#define ADC_ISR_EOC(x)                  (((uint32_t)(((uint32_t)(x))<<ADC_ISR_EOC_SHIFT))&ADC_ISR_EOC_MASK)
#define ADC_ISR_EOSEQ_MASK              0x8u
#define ADC_ISR_EOSEQ_SHIFT             3u
#define ADC_ISR_EOSEQ(x)                (((uint32_t)(((uint32_t)(x))<<ADC_ISR_EOSEQ_SHIFT))&ADC_ISR_EOSEQ_MASK)
#define ADC_ISR_OVR_MASK                0x10u
#define ADC_ISR_OVR_SHIFT               4u
#define ADC_ISR_OVR(x)                  (((uint32_t)(((uint32_t)(x))<<ADC_ISR_OVR_SHIFT))&ADC_ISR_OVR_MASK)
#define ADC_ISR_AWD_MASK                0x10u
#define ADC_ISR_AWD_SHIFT               4u
#define ADC_ISR_AWD(x)                  (((uint32_t)(((uint32_t)(x))<<ADC_ISR_AWD_SHIFT))&ADC_ISR_AWD_MASK)
...
#define ADC_CFGR1_EXTSEL(x)              (((uint32_t)(((uint32_t)(x))<<ADC_CFGR1_EXTSEL_SHIFT))&ADC_CFGR1_EXTSEL_MASK)
...
#define ADC_CFGR1_DISCEN_MASK           0x10000u
#define ADC_CFGR1_DISCEN_SHIFT          16u
#define ADC_CFGR1_DISCEN(x)             (((uint32_t)(((uint32_t)(x))<<ADC_CFGR1_DISCEN_SHIFT))&ADC_CFGR1_DISCEN_MASK)
